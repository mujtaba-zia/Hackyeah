...
export const PROPS: readonly PropDef[] = [
  ...
  // Milestone 4 detail pass: scattered greenery, street furniture and a few
  // taller structures for vertical depth. Placements were checked against the
  // terrain grid and every route, waiting spot and landmark footprint.
  { tile: { tx: 9, ty: 14 }, texture: 'p-tower-a', flipX: true },
  { tile: { tx: 6, ty: 11 }, texture: 'p-tower-b' },
  { tile: { tx: 26, ty: 30 }, texture: 'p-watertower' },
  { tile: { tx: 2, ty: 31 }, texture: 'p-billboard' },
  { tile: { tx: 22, ty: 13 }, texture: 'p-streetlight', flipX: true },
  { tile: { tx: 41, ty: 9 }, texture: 'p-trafficlight' },
  { tile: { tx: 4, ty: 24 }, texture: 'p-busstop' },
  { tile: { tx: 41, ty: 22 }, texture: 'p-sign' },
  { tile: { tx: 37, ty: 24 }, texture: 'p-foodtruck', flipX: true },
  { tile: { tx: 14, ty: 39 }, texture: 'p-garbage' },
  { tile: { tx: 36, ty: 2 }, texture: 'p-cone' },
  { tile: { tx: 9, ty: 2 }, texture: 'p-streetlight' },
  { tile: { tx: 20, ty: 38 }, texture: 'p-trafficlight', flipX: true },
  { tile: { tx: 15, ty: 7 }, texture: 'p-busstop' },
  { tile: { tx: 24, ty: 41 }, texture: 'p-flowers' },
  { tile: { tx: 8, ty: 13 }, texture: 'p-rock', scale: 0.9 },
  { tile: { tx: 29, ty: 2 }, texture: 'p-shrub', flipX: true },
  { tile: { tx: 9, ty: 41 }, texture: 'p-flowers' },
  { tile: { tx: 30, ty: 41 }, texture: 'p-shrub', scale: 0.9 },
  { tile: { tx: 36, ty: 31 }, texture: 'p-fence' },
  { tile: { tx: 8, ty: 15 }, texture: 'p-rock', flipX: true },
  { tile: { tx: 9, ty: 12 }, texture: 'p-flowers', scale: 0.9 },
  { tile: { tx: 32, ty: 29 }, texture: 'p-shrub' },
  { tile: { tx: 16, ty: 41 }, texture: 'p-flowers' },
  { tile: { tx: 7, ty: 25 }, texture: 'p-rock', scale: 0.9, flipX: true },
  { tile: { tx: 37, ty: 29 }, texture: 'p-shrub' },
  { tile: { tx: 36, ty: 28 }, texture: 'p-flowers' },
  { tile: { tx: 7, ty: 38 }, texture: 'p-shrub', scale: 0.9 },
  { tile: { tx: 34, ty: 23 }, texture: 'p-fence', flipX: true },
  { tile: { tx: 33, ty: 2 }, texture: 'p-rock' },
  { tile: { tx: 33, ty: 13 }, texture: 'p-flowers', scale: 0.9 },
  { tile: { tx: 23, ty: 12 }, texture: 'p-shrub' },
  { tile: { tx: 5, ty: 20 }, texture: 'p-flowers', flipX: true },
  { tile: { tx: 26, ty: 33 }, texture: 'p-rock', scale: 0.9 },
  { tile: { tx: 25, ty: 2 }, texture: 'p-shrub' },
  { tile: { tx: 21, ty: 31 }, texture: 'p-flowers' },
  { tile: { tx: 5, ty: 25 }, texture: 'p-shrub', scale: 0.9, flipX: true },
  { tile: { tx: 39, ty: 8 }, texture: 'p-fence' },
  { tile: { tx: 27, ty: 38 }, texture: 'p-rock' },
  { tile: { tx: 9, ty: 22 }, texture: 'p-flowers', scale: 0.9 },
  { tile: { tx: 20, ty: 2 }, texture: 'p-shrub', flipX: true },
  { tile: { tx: 32, ty: 20 }, texture: 'p-flowers' },
  { tile: { tx: 7, ty: 20 }, texture: 'p-rock', scale: 0.9 },
  { tile: { tx: 7, ty: 12 }, texture: 'p-shrub' },
  { tile: { tx: 37, ty: 8 }, texture: 'p-flowers', flipX: true },
  { tile: { tx: 41, ty: 13 }, texture: 'p-shrub', scale: 0.9 },
];
